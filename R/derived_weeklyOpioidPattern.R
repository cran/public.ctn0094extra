#' @title Patient UDS Opioid Weekly Pattern Data
#'
#' @description Show the pattern of positive, negative, and missing urine drug
...
#' @docType data
#'
#' @usage data(derived_weeklyOpioidPattern)
#'
#' @format A tibble with `r scales::comma(nrow(derived_weeklyOpioidPattern))`
#'    rows and columns:
#'    \describe{
#'      \item{who}{Patient ID}
